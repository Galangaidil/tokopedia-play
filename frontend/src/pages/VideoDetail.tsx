...
const VideoSkeleton: React.FC = () => {
    return (
        <>
            <div role="status"
                 className="flex items-center justify-center h-56 w-full lg:h-[600px] rounded-lg animate-pulse bg-gray-700">
                <svg className="w-10 h-10 text-gray-600" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
...
function VideoDetail() {
    ...
    } = useFetch<CommentInterface[]>(`videos/${id}/comments`, "GET");
            ...
            <div className="grid grid-cols-1 lg:grid-cols-6 gap-8">
                <div className="lg:col-span-4">
                    ...
                    <div className="mt-4 space-y-4">
                        ...
                        <CommentForm
                            comment={formComment}
                            handleFormSubmit={handleSubmitComment}
